        ...
        <div class="page-container">
            <div class="page-content">
                ...
                <div class="card">
                    ...
                    <div class="card-footer d-flex justify-content-between align-items-center flex-basis-0">
                        ...
                        <a href="https://blog.viladomat.com/consejos-motivacion-fitness/"
                            class="btn btn-outline-dark btn-sm">MAS INFO</a>
            ...
            <div class="page-sidebar text-center">
                ...
                <div class="progress">
                    <ul class="progress">
                        ...
                        <?php
                                ...
                                ?>
                        <li data-name="CURSOS INSCRITOS"
                            data-percent=<?php echo mysqli_num_rows($obtener_codigo_cliente_curso) ?>>
                            ...
                            <svg viewBox="-10 -10 220 220">
                                <path
                                    ...
                                    stroke-dashoffset="550"></path> <!-- SE TRABAJA EN UNA ESCALA DE 630 -->
                            </svg>
                        </li>
                ...
                <form action="datos_adicionales_cliente.php" method="POST" class="formulario">
                    ...
                    <input type="text" class="formulario__input" name="peso">
                    <label for="" class="formulario__label">Medida Piernas</label>
                    <input type="text" class="formulario__input" name="peso">
                    <label for="" class="formulario__label">Medida Brazos</label>
                    <input type="text" class="formulario__input" name="peso">
                    <label for="" class="formulario__label">Medida Cintura</label>
