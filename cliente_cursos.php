                        ...
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">
                                <div class="blog-media">
                                    <img src="assets/imgs/<?php echo $datosinternosjson['imagen']  ?>" alt=""
                                        class="w-100">
                                    <a href="#"
                                        class="badge badge-primary">#<?php echo $datosinternosjson['titulo']  ?></a>
                                </div>
                            </div>
                            ...
                            <div class="card-footer p-0 text-center">
                                <a href="<?php echo $datosinternosjson['pagina']?>"
                                    class="btn btn-outline-dark btn-sm">Ver curso</a>
                            </div>
                        </div>
                    </div>
                    <?php
