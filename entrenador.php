        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $datos_usuario['correo']; ?></td>
                    <td> <a href="#modal" class="tablas ml-4 btn btn-primary rounded btn-warning mt-1 btn-sm "
                            data-toggle="modal" data-target="#modalestadisticas<?php echo $datos_relacion_cliente_datos['id_relacion_clientes_datos']; ?>">Ver mas</a></td>
                </tr>
                <?php include('ModalEstadisticas.php');?>
            </tbody>
            <?php
                            }
                        }
